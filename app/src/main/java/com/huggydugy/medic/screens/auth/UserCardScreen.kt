...
import com.huggydugy.medic.ui.theme.DarkLight
...
@Composable
fun UserCardScreen(navController: NavController){
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        ThemeTextField("Имя")
        Spacer(modifier = Modifier.height(20.dp))
        ThemeTextField("Отчество")
        Spacer(modifier = Modifier.height(20.dp))
        ThemeTextField("Фамилия")
        Spacer(modifier = Modifier.height(20.dp))
        ThemeTextField("Дата рождения")
        Spacer(modifier = Modifier.height(20.dp))
